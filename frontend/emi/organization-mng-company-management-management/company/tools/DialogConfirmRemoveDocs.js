...
export function DialogConfirmRemoveDocs(props) {

    const { T, dataSource,
        openConfirmDialogRemoveDocs,
        setOpenConfirmDialogRemoveDocs,
        removeDocuments,
        setOpenDialogProcess,
        selected } = props
    const classes = useStyles();
    const handleClose = () => {
        setOpenConfirmDialogRemoveDocs(false);
    };
    const handleUploadFile = () => {
        removeDocuments({
            variables: {
                companyId: dataSource.id,
                fileUrls: selected
            }
        });
        setOpenConfirmDialogRemoveDocs(false);
    ...
    return (
        <Dialog
            key="dialogconfirmremovedocs"
            open={openConfirmDialogRemoveDocs}
            onClose={handleClose}
