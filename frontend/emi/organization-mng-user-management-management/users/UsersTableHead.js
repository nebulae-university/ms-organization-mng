...
function UsersTableHead(props) {
    ...
    const order = useSelector(({ UserManagement }) => UserManagement.users.order);
    ...
    const rows = [
        {
            ...
            label: T.translate("users.table_colums.firstName"),
            sort: false
        },
        {
            id: 'lastName',
            align: 'left',
            disablePadding: false,
            label: T.translate("users.table_colums.lastName"),
            sort: false
        },
        {
            id: 'emailAddress',
            align: 'left',
            disablePadding: false,
            label: T.translate("users.table_colums.emailAddress"),
            sort: false
        },
        {
            id: 'createdAt',
            align: 'left',
            disablePadding: false,
            label: T.translate("users.table_colums.createdAt"),
            sort: false
        },
        {
            id: 'active',
            align: 'right',
            disablePadding: false,
            label: T.translate("users.table_colums.active"),
            sort: false
        }
    ];
                                ...
                                <MenuList>
                                    <MenuItem
                                        onClick={() => dispatch(Actions.openDialog({
                                            children: (
                                                <React.Fragment>
                                                    <DialogTitle id="alert-dialog-title">{T.translate("users.remove_dialog_title")}</DialogTitle>
                                                    <DialogContent>
                                                        <DialogContentText id="alert-dialog-description">
                                                            {T.translate("users.remove_dialog_description")}
                                                        </DialogContentText>
                                                    </DialogContent>
                                                    <DialogActions>
                                                        <Button onClick={() => { dispatch(Actions.closeDialog()); closeSelectedUsersMenu() }} color="primary">
                                                            {T.translate("users.remove_dialog_no")}
                                                        </Button>
                                                        <Button onClick={() => { dispatch(Actions.closeDialog()); closeSelectedUsersMenu(); removeHandler() }} color="primary" autoFocus>
                                                            {T.translate("users.remove_dialog_yes")}
                                                        </Button>
                                                    </DialogActions>
                                                </React.Fragment>
                                            )
                                    ...
                                    >
                                        ...
                                        <ListItemText primary={T.translate("users.remove")} />
