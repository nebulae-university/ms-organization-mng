...
![Intro](docs/images/ms-organization-mng_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [organization-mng](#backend_organization-mng)
        * [Environment variables](#backend_organization-mng_env_vars)
        * [Event Sourcing](#backend_organization-mng_eventsourcing)
        * [CronJobs](#backend_organization-mng_cronjobs)
...
│   ├── organization-mng                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/organization-mng/schema.gql)
...
### GraphQL Queries
#### getHelloWorldFromorganization-mng
...
#### organization-mngHelloWorldSubscription
...
## organization-mng <a name="backend_organization-mng"></a>
...


### Environment variables <a name="backend_organization-mng_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/organization-mng/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-organization-mng.yaml)

### Event Sourcing <a name="backend_organization-mng_eventsourcing"></a>
...
### CronJobs <a name="backend_organization-mng_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-university/ms-organization-mng.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-university/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-organization-mng/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-organization-mng/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-university/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-organization-mng/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-organization-mng/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-organization-mng/backend/organization-mng/.env   *WORKING_FOLDER*/ms-organization-mng/playground/emi-gateway/.env  
